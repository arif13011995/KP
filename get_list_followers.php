...
<div class="preloader_hide">
	...
	<div id="page" class="single_page">
		...
		while($cursor != 0){
			if($cursor != 0)
				$loc = 'followers/list.json?cursor='.$cursor.'&screen_name='.$screen_name.'&count=200';
			else
				break;
			...
			foreach($data['users'] as  $bebas){
			 ...
			 $sql = "INSERT IGNORE INTO get_list_followers VALUES
					(
					 '".$screen_name."'
					, '".$bebas->created_at."'
					, '".$bebas->id_str."'
		...
		<div class="container">	
		  ...
		  <table class="table table-striped">
		    ...
		    <tbody>
			      <?php 
			      $sql1 =$db->query("select * from get_list_followers where official = '".$screen_name."'");
			      $i=1;
